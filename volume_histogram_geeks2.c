...
Instead of maintaing two arrays of size n for storing left 
and right max of each element, 
...
we will calculate water trapped 
on smaller element out of A[lo] and A[hi] first 
and move the pointers till lo doesn’t cross hi.
*/

// WE CAN IGNORE THIS BETTER SOLUTION FOR NOW.
